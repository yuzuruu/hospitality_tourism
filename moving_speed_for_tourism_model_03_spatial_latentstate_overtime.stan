...
model {
  ...
  beta_lon[1] ~ normal(0, 1);
  beta_lat[1] ~ normal(0, 1);
  beta_car[1] ~ normal(0, 1);
  beta_person[1] ~ normal(0, 1);
  beta_motorcycle[1] ~ normal(0, 1);
  for (t in 2:T) {
    beta_lon[t] ~ normal(beta_lon[t-1], sigma_beta);
    beta_lat[t] ~ normal(beta_lat[t-1], sigma_beta);
    beta_car[t] ~ normal(beta_car[t-1], sigma_beta);
    beta_person[t] ~ normal(beta_person[t-1], sigma_beta);
    beta_motorcycle[t] ~ normal(beta_motorcycle[t-1], sigma_beta);
  }
